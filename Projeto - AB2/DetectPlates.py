...
def detectPlatesInScene(imgOriginalScene):
    ...
    print("\n" + str(len(listOfPossiblePlates)) + " Placas encontradas") 
    ...
    if Main.showSteps == True: 
        ...
        for i in range(0, len(listOfPossiblePlates)):
            ...
            print("Placa possível " + str(i) + ", Clique para continuar . . .")

            cv2.imshow("4b", listOfPossiblePlates[i].imgPlate)
            cv2.waitKey(0)

        print("\nDetecção da placa completada, clique quaisquer lugar para iniciar a detecção por caracteres...\n")
        cv2.waitKey(0)
