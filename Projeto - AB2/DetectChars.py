...
def loadKNNDataAndTrainKNN():
    ...
    try:
        ...
        print("Erro, não foi possível abrir o arquivo classifications.txt\n")  
        os.system("pause")
        return False                                                                        
    ...
    try:
        ...
        print("Erro, não foi possível abrir o arquivo classifications.txt flattened_images.txt\n")  
        os.system("pause")
        return False                                                                        

    npaClassifications = npaClassifications.reshape((npaClassifications.size, 1))       
    kNearest.setDefaultK(1)                                                             
    kNearest.train(npaFlattenedImages, cv2.ml.ROW_SAMPLE, npaClassifications)           # Treinando KNN
